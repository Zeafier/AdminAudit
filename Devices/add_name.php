...
if(isset($_POST['add'])){ # add new name
    $addnew = new addname();
    $result = $addnew -> newname($con);
    if($result == "fail"){
        echo "<script>alert('Something went wrong. please try again.');</script>";
    }else{
        echo "<script>alert('Name/s has been added.');</script>";
        $extra="add_name.php";
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Add Device name</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
                      ...
                      <form name="register" role="form" onsubmit="" action="" method="post">
                          <div class="card-body">
                              <div class="form-group">
                                <label for="Faculty">Faculty</label>
                                  <select class="form-control" id="Faculty" name="faculty">
                                      <?php # select all faculties from database
                              ...
                              <div class="form-group" id="div_faculty">
                                <label for="no_faculty">Faculty</label>
                              ...
                              <div class="form-group">
                                <label for="usertype">User Type</label>
                                  <select class="form-control" id="usertype" name="usertype">
                                      <?php # select all user types from database
                              ...
                              <div class="form-group" id="div_utype">
                                <label for="no_utype">User type</label>
                              ...
                              <div class="form-group">
                                <label for="Area">Location</label>
                                  <select class="form-control selectpicker" id="Area" name="location" data-live-search="true">
                                      <?php # select all locations from database
                              ...
                              <div class="form-group" id="div_area">
                                <label for="no_area">Location</label>
                              ...
                              <div class="form-group">
                                <label for="Type">Device</label>
                                  <select class="form-control selectpicker" id="device_type" name="device_type" data-live-search="true">
                                      <?php # select all devices from database
                              ...
                              <div class="form-group" id="form_type">
                                <label for="Type">Device type</label>
                                  <select class="form-control" id="Type" name="type">
                                      <?php # select all devices type from database
                              ...
                              <div class="form-group" id="div_model">
                                <label for="no_model">Model</label>
                                  <input class="form-control" id="no_model" name="model2" type="text" placeholder="Model"/>
                              </div> <!-- Show if model not on list -->
                              <!-- Show if device not on list -->
                              <div class="form-group">
                                <label for="no_model">Number of devices</label>
                                  <input class="form-control" id="no_model" name="numberdev" type="number" Value="1"/ required>
                              </div>
                              <div class="form-group">
                                <label for="devname">Device name</label>
                                  <input class="form-control" name="devname" id="devname" type="text" placeholder="Device name"/>
                              </div>
                              <div class="form-group">
                                <label for="Additional information">Additional information</label>
                                  <input class="form-control" id="sn" name="additional" type="text" placeholder="Additional information"/>
                              </div>
                          </div>
