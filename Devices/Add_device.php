...
$sn = ""; $tag = ""; $brand = ""; $model = "";
$adddevice = new addasset();
$adddevice -> newasset($con);
?>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="../index.php" class="brand-link">
      <img src="../dist/img/NewLogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
                  ...
                  <div class="card card-primary">
                      ...
                      <form name="register" role="form" onsubmit="" action="" method="post">
                          <div class="card-body">
                              <div class="form-group">
                                <label for="Type">Faculty</label>
                                  <select class="form-control" id="Faculty" name="faculty">
                                      <?php #select faculty from database
                              ...
                              <!-- Show if faculty is not on list -->
                              ...
                              <div class="form-group">
                                <label for="usertype">User Type</label>
                                  <select class="form-control" id="usertype" name="usertype">
                                      <?php # Select user type from database
                              ...
                              <!-- Show if user type is not on list -->
                              ...
                              <div class="form-group">
                                <label for="Location">Location</label>
                                  <select class="form-control selectpicker" id="Area" name="location" data-live-search="true">
                                      <?php #select rooms location from database
                              ...
                              <!-- Show if location is not on list -->
                              ...
                              <div class="form-group">
                                <label for="Type">Device</label>
                                  <select class="form-control selectpicker" id="device_type" name="device_type" data-live-search="true">
                                      <?php # Select devices from database
                              ...
                              <div class="form-group" id="form_type">
                                <label for="Type">Device type</label>
                                  <select class="form-control" id="Type" name="type">
                                      <?php #select device type from database
                              ...
                              </div> <!-- Show if type is not on list -->
                              <div class="form-group" id="form_brand">
                                <label for="Brand">Brand</label>
                                  <select class="form-control" id="Brand" name="brand">
                                      <?php #Select brands from database
                              ...
                              </div><!-- Show if specs is not on list -->
                              <div class="form-group">
                                <label for="Serial number">Serial Number</label>
                                  <input class="form-control" id="sn" name="serial" type="text" placeholder="Serial number"/ required>
                              </div>
                              <div class="form-group">
                                <label for="Tag">Tag</label>
                                  <input class="form-control" name="tag" type="tag" placeholder="TAG"/ required>
                              </div>
                          </div>
