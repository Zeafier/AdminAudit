          ...
          <div class="row">
              <div class="col-md-12">
                  <div class="card card-primary">
                      ...
                      <form name="itemfrom" role="form" onsubmit="" action="" method="post">
                          <div class="card-body">
                              <?php
                                $stmnt = $con -> prepare("Select  _model_name_, UPPER(_type_name_), _brand_name_ FROM _decomission_item_ AS di INNER JOIN _model_ ON di._mode_id_ = _model_._mID_ INNER JOIN _types_ ON _types_._tID_ = di._typy_ID_ INNER JOIN _brands_ ON _brands_._bID_ = di._brand_ID_ WHERE di._di_ID_ = ? ORDER BY _type_name_");
                                $stmnt -> bind_param("i", $itemid);
                                $stmnt -> execute();
                                $stmnt -> bind_result($devicemodel, $devicetype, $devicebrand);
                                $stmnt -> fetch();
                                $stmnt -> close();
                              ?>
                          ...
                          <div class="card-footer">
                              ...
                              <button class="btn btn-danger" style="float: right; margin-right: 10px;" onclick="window.location = 'http://'+window.location.hostname+'/Devices/devices.php'; return false" name="cancel">Cancel</button>
                          </div>
                      </form>
                  </div>
              </div>
