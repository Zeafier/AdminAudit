...
if(isset($_GET['uid']) && !empty($_SESSION['login']) && $_SESSION['isadmin'] == 1){
    ...
    $msg = "UPDATE _decomission_item_ SET _visible_ = 0 WHERE _di_ID_ = ?";
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                ...
                <li class="nav-item">
                <a href="../Devices/devices.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Devices</p>
                </a>
              </li>
                      ...
                      <table id="UserTable" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            <?php
                                ...
                                while($stmnt->fetch()){ ?>
                                     <tr>
                                         <td><a onclick="myFunction(<?php print $deviceid;?>)" style="color: black; display: block; width: 100%; cursor: pointer;"><?php print $devicetype; ?></a></td>
                                         <td><a onclick="myFunction(<?php print $deviceid;?>)" style="color: black; display: block; width: 100%; cursor: pointer;"><?php print $devicebrand; ?></a></td>
                                         <td><a onclick="myFunction(<?php print $deviceid;?>)" style="color: black; display: block; width: 100%; cursor: pointer;"><?php print $devicemodel; ?></a></td>
                                         <?php if($_SESSION['isadmin'] == 1){ ?>
                                      <td>
                                          <div class="col-10">
                                              <div class="row">
                                                  <div class="col-sm-4 col-md-3">
                                                      <a onclick="myFunction(<?php print $deviceid;?>)" ><button class = "btn btn-primary btn-xs" title="Edit Device"><i class="fa fa-pencil"></i></button></a>
                                                  </div>
                                                  <div class="col-sm-6">
                                                      <a onclick="myRemove(<?php print $deviceid;?>)" ><button class="btn btn-danger btn-xs" title="Remove device"><i class="fa fa-trash-o "></i></button></a>
                                                  </div>
                                              </div>
                                          </div>
                                        </td>
