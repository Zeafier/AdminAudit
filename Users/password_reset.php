...
function username($con, $userid){
    $msg="SELECT _username_ FROM _user_log_ WHERE _uID_ = ?";
...
function changepass($con, $userid){
    if(isset($_POST['reset'])  && !empty($_SESSION['login']) && $_SESSION['isadmin'] == 1)
    {
        ...
        if(empty($newpass) || empty($confirmpass)){
            ...
            $msg="UPDATE _user_log_ SET _password_ = ?, password_change = ? WHERE _uID_ = ?";
            $stmnt1 = $con -> prepare($msg);
            $stmnt1 -> bind_param("sii", $hpw, $passchange, $userid);
            if($stmnt1->execute()){
                      ...
                      <form name="register" role="form" onsubmit="" action="" method="post">
                          <div class="card-body">
                              <div class="form-group">
                                ...
                                <input class="form-control" id="username" type="username" value="<?php username($con, $userid); ?>" disabled/>
                              </div>
                              <div class="form-group">
                                <label for="user_password">Password</label>
                                  <input class="form-control" id="user_password" type="password" placeholder="Password" name="password"/ required>
                              </div>
                              <div class="form-group">
                                <label for="user_rpassword">Confirm password</label>
                                  <input class="form-control" id="user_rpassword" type="password" placeholder="Confirm Password" name="c_password"/ required>
                              </div>
                              <div class="form-group">
                          ...
                          <div class="card-footer">
                              <button class="btn btn-primary" style="float: right;" type="submit" name="reset">Reset</button>
