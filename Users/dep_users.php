...
{
    $adminid=clean($_GET['rid']);
    $msg = "UPDATE _departments_ SET _visible_ = 0 WHERE _dID_ = ?";
    $stmnt = $con->prepare($msg);
    $stmnt -> bind_param("i", $adminid);
    if($stmnt -> execute()){
        echo "<script>alert('Department has been removed');</script>";
        $stmnt->close();
        $extra="dep_users.php";
                    ...
                    <div class="card-body">
                      <table id="UserTable" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            $stmnt = $con->prepare($msg);
                            $stmnt -> execute();
                            $stmnt -> bind_result($id, $department, $visib);
                            while($stmnt->fetch()){?>
                                <tr>
                                  ...
                                  <td>
                                      <div class="col-10">
                                          <div class="row">
                                              ...
                                              <div class="col-sm-4">
                                                  <a onclick="myRemove(<?php print $id;?>)"><button class="btn btn-danger btn-xs" title="Remove department"><i class="fa fa-trash-o "></i></button></a>
                                              </div>
                                          </div>
                                      </div>
                                    </td>
