                      ...
                      <form name="register" role="form" onsubmit="" action="" method="post">
                          <div class="card-body">
                              <div class="form-group">
                                ...
                                <input class="form-control" id="user_name" name="user_name" type="name" placeholder="Name"/ required>
                              </div>
                              <div class="form-group">
                              ...
                              <div class="form-group">
                                <label for="user_surname">Surname</label>
                                  <input class="form-control" id="user_surname" name="user_surname" type="surname" placeholder="Surname"/ required>
                              </div>
                              <div class="form-group">
                              ...
                              <div class="form-group" id="div_title">
                                <label for="Title">Choose title</label>
                                  <select class="form-control" id="Title" name="Title">
                                      <?php 
                                            //select title from database and place in select box
                          ...
                          <div class="card-footer">
                              <input class="btn btn-primary" style="float: right;" type="submit" name="Create_staff" value="Create">
