...
$decomadd = new additem();
$decomadd -> newdecom($con);
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Add decomission item</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
                  ...
                  <div class="card card-primary">
                      ...
                      <form name="register" role="form" onsubmit="" action="" method="post">
                          <div class="card-body">
                              <div class="form-group">
                                <label for="Type">Device type</label>
                                  <select class="form-control selectpicker" id="Type" name="type" data-live-search="true">
                                      <?php # select all types from database
                              ...
                              <!-- show if type is not on the list -->
                              ...
                              <!-- show if brand is not on the list -->
                              ...
                              <!-- show if model is not on the list -->
                              ...
                              </div> <!-- show if model is not on the list -->
                              <div class="form-group">
                                <label for="S_N">Serial number</label>
                                  <input class="form-control" id="S_N" name="sn" type="text" placeholder="Serial number"/>
                              </div>
                              <div class="form-group">
                                <label for="Tag">Asset Tag</label>
                                  <input class="form-control" id="Tag" name="tag" type="text" placeholder="Asset Tag"/>
                              </div>
                              <div class="form-group">
                                <label for="Reason">Decomission reason</label>
                                  <select class="form-control selectpicker" id="Reason" name="reason" data-live-search="true">
                                      <?php # select general decomission reasons
                              ...
                              <!-- show if reason is not on the list -->
                              ...
                              </div><!-- show if reason is not on the list -->
                              <div class="form-group">
                                <label for="DecomissionDate">Date</label>
                                  <input class="form-control" id="DecomissionDate" name="DecomissionDate" type="date"/ required>
                              </div>
                          </div>
                          <div class="card-footer">
                              <button class="btn btn-primary" style="float: right;" type="submit" name="add">Add</button>
                              <button class="btn btn-danger" style="float: right; margin-right: 10px;" onclick="window.location = 'http://'+window.location.hostname+'/Decomission/add_decom.php'; return false" name="cancel">Cancel</button>
                          </div>
                      </form>
                  </div>
              </div>
