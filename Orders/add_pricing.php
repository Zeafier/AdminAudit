...
$itemadd = new newprice();
$itemadd -> addpricing($con);
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item">Pricing and Quantity</li>
                          ...
                          <div class="card-body">
                              <div class="form-group">
                                <label for="Type">Device type</label>
                                  <select class="form-control" id="Type" name="type">
                                      <?php #select device type and place it in combobox
                              ...
                              <div class="form-group">
                                <label for="quantity">Quantity</label>
                                  <input class="form-control" id="quantity" name="quantity" step="any" type="number" placeholder="Quantity"/>
                              </div>
                              <div class="form-group">
                                <label for="price">Price</label>
                                  <input class="form-control" id="price" name="price" step="any" type="number" placeholder="Price in £"/>
                              </div>
                          </div>
                          <div class="card-footer">
                              <button class="btn btn-primary" style="float: right;" type="submit" name="add">Add</button>
                              <button class="btn btn-danger" style="float: right; margin-right: 10px;" onclick="window.location = 'http://'+window.location.hostname+'/Orders/pricing.php'; return false" name="cancel">Cancel</button>
                          </div>
                      </form>
                  </div>
              </div>
